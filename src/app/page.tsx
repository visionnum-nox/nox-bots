...
export default function Page() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* ═══ HERO — Resend style: LEFT-aligned, serif headline ═══ */}
      ...
      {/* ═══ INTEGRATE — Code block like Resend ═══ */}
      <section className="py-32 sm:py-44 px-6">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="max-w-[700px] mx-auto code-card">
...
<span className="ln">14</span><span className="cm">// Бот работает 24/7 ✓</span>
      ...
      {/* ═══ FEATURES — Split sections like Resend ═══ */}
      <section id="features" className="section-glow py-32 sm:py-44 px-6">
        <div className="max-w-[1200px] mx-auto">
          ...
          {/* Two feature cards side by side — like Resend Test Mode / Webhooks */}
          ...
          {/* Full-width feature with chat mockup — like Resend Editor section */}
          <div className="feat-card mb-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-2.5 p-4 rounded-xl" style={{background:'rgba(255,255,255,0.02)'}}>
                <div className="msg msg-bot">👋 Добро пожаловать в Beauty Salon! Выберите услугу:</div>
                ...
                <div className="msg msg-user">✂️ Стрижка</div>
                <div className="msg msg-bot">Выберите дату:<br/><span className="t2">Пн 25.03 · Вт 26.03 · Ср 27.03</span></div>
                <div className="msg msg-user">Вт 26.03</div>
                <div className="msg msg-bot">✅ Вы записаны!<br/>Стрижка · Вт 26.03 · 14:00<br/><span className="t3">Напомним за 1 час</span></div>
              </div>
            </div>
          </div>
      ...
      {/* ═══ QUOTE — Resend style: big centered testimonial ═══ */}
      <section className="py-32 sm:py-44 px-6">
      ...
      {/* ═══ EVERYTHING IN YOUR CONTROL — feature grid ═══ */}
      <section className="section-glow py-32 sm:py-44 px-6">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-[32px] sm:text-[44px] font-bold tracking-tight text-center mb-16">Всё под вашим контролем</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              <div key={x.t} className="feat-card">
      ...
      <section id="pricing" className="py-32 sm:py-44 px-6">
        <div className="max-w-[900px] mx-auto">
          ...
          <p className="text-center t2 text-[16px] mb-16">Фиксированная стоимость. Без сюрпризов.</p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            {[
              ...
              <div key={p.n} className={`rounded-2xl p-6 flex flex-col ${p.pop?'bg-white text-black':'feat-card'}`}>
        ...
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            {[
              ...
              <div key={r.n} className="feat-card text-center">
